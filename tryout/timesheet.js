...
({ 
    ...
    { "use strict";
      ...
      ,line2 = [ 'FULLTIME:', '', 'PART TIME:','', 'CASUAL:','', 'DSW CA LEVEL:','',
                 'ALTERNATIVE DSW CA LEVEL:','', 'PERIOD ENDING:','']
      ,line2Pos = [0,data2.fulltime, 8, data2.parttime, 16, data2.casual, 25,
                   data2.dsw, 40, data2.dsw2, 65, data2.ending, 100] 
      ...
      function text(str, box, al, attr) {
          ...
          var textElement = paper.text(x, y, str).attr({'font-family': font, 'font-size': size, 'font-weight': weight,  
