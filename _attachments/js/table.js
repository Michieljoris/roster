...
({inject: ['pouchDS'],
  factory: function() {
    ...
    //-----------------------Filter Builder--------------------------------------
    var advancedFilter = isc.FilterBuilder.create({
			       // ID:"advancedFilter"
    ...
    var simpleFilterToggle = isc.Label.create({
    ...
    var saveStateButton = isc.IButton.create({
			 // ID:"saveStateButton",
			 title:"Store table",
			 width:100,
			 click : function () {
    ...
    var filterStack = isc.VLayout.create({
			 // ID:'filterStack',
			 membersMargin:10,
			 align:'left',
