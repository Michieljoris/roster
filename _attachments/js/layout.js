define(
  {
	...
	create({ ID:'rightSideLayout',
		 ...
		 ,sections:[
		   {name:'datatable', showHeader:false, hidden: true, title:'Data', items:[dataTable]}
		   // ,{name: 'calendar', title:"Calendar", expanded:true, hidden: false,items:[shiftCalendar]}
		   ,{name: 'tabset', title:"Edit", expanded:true,  hidden: true, items:[tabSet]}
		 ]
	       });
