...
var Pouch = function Pouch(name, opts, callback) {
  ...
  if (!Pouch.adapters[opts.adapter]) {
    throw 'Adapter is missing: ' + opts.adapter;
  }
        ...
        function writeDoc(docInfo, callback) {
            ...
            function finish() {
                ...
                dataReq.onsuccess = function(e) {
                    ...
                    var t1 =  txn.objectStore(DOC_STORE);
                    // window.t1 = t1;
                    // window.docInfo = docInfo;
                    // console.log(t1, docInfo, docInfo.metadata);
                    var metaDataReq = t1.put(docInfo.metadata);
