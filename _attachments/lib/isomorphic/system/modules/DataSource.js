...
// 2. Optional support for PDF Export requires Flying Saucer, iText and jTidy, introducing:<br>
...
// &nbsp;&nbsp;- jTidy: jtidy-r938.jar: +externalLink{http://jtidy.sourceforge.net/license.html,MIT license}
// <P>
...
// <P>
// Note that this setting only prevents the user from 
		...
		switch (operationType) {
			...
			case "update":
                ...
                if (serverRecordIndex == -1) {
                    ...
                    // *Skip the __ref property if its defined
                    
                    var record = request.data,
                        ref;
