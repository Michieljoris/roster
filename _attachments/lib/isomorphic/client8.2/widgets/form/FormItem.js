...
isc.FormItem.addMethods({
    ...
    _eventMaskTemplate:[
        ...
        "'>",
        null,   // 9 spacerHTML - for IE, we'll lazily add a spacer here, otherwise a &nbsp; - 
    ...
    _refocusAfterRedraw : function (delayed) {
        ...
        if (delayed && shouldRefocus) this.resetToLastSelection();
    ...
    // An optional notification method that fires when the parent form's values are changed 
    // by a +link{ValuesManager}.
    // @visibility internal
    //<    
...
//JMD: handle null value in isc.getKeyForValue instead?
    ...
    _$smart:"smart",
	setValue : function (newValue, allowNullValue, timeCritical) {
