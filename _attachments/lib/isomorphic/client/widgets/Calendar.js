...
// work out the size and position of events
    ...
    for (var i = 0; i < events.getLength(); i++) {
        ...
        // var startHours = curr[this.startDateField].getUTCHours(),
            startMinutes = curr[this.startDateField].getMinutes(),
            // startMinutes = curr[this.startDateField].getUTCMinutes(),
        ...
        var eventEndDay = curr[this.endDateField].getDay(),
            // endHours = curr[this.endDateField].getUTCHours(),
            endHours = curr[this.endDateField].getHours(),
            // endMinutes = curr[this.endDateField].getUTCMinutes(),
...
_getEventDialogTitle : function (startDate, endDate) {
    ...
    var sTime = isc.Time.toTime(startDate, this.timeFormatter, true),
...
isc.MonthSchedule.addProperties({
    ...
    cellHoverHTML : function (record, rowNum, colNum) {
        ...
        if (!this.rowIsHeader(rowNum) && record["event" + fieldIndex] != null) {
            ...
            var retVal = "";
            for (var i = 0; i < evtArr.length; i++) {
                var eTime = isc.Time.toTime(evtArr[i][this.creator.startDateField], 
